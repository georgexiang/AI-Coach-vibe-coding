...
down_revision: Union[str, None] = '16f9f0ba6e9d'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('training_materials', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_training_materials_product'), ['product'], unique=False)
    ...
    with op.batch_alter_table('material_versions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_material_versions_material_id'), ['material_id'], unique=False)
