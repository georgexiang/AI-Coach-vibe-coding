...
- Usage: Reference from command with `@/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
