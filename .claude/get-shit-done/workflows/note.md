...
- **Global scope**: `/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/notes/`)
...
2. Glob `/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/notes/` — works in any directory
