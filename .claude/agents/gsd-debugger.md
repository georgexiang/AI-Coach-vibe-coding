...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude
                  → checks /Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done
                  → writes to /Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done/hooks/
...
@/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/huqianghui/Downloads/1.github/AI-Coach-vibe-coding/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
